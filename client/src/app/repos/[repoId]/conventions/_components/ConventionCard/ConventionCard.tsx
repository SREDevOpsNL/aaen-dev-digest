      ...
      <div style={s.cardMain}>
        ...
        {editing ? (
          <>
            ...
            <div style={{ height: 10 }} />
            <Textarea value={rationale} onChange={setRationale} rows={3} placeholder={t("card.rationaleLabel")} />
            <div style={s.editRow}>
          ...
          <>
            ...
            <div style={s.evidence}>
              <div style={s.evidenceHeader}>
                {evidenceHref ? (
                  <a className="mono" href={evidenceHref} target="_blank" rel="noreferrer" title={t("card.openOnGitHub")} style={s.evidenceLink}>
              ...
              <pre className="mono" style={s.evidenceCode}>{candidate.evidence_snippet}</pre>
            </div>
            <div style={s.confidenceRow}>
              <span>{t("card.confidence")}</span>
              <div style={s.confidenceBar}>
                <ProgressBar value={percentage} color={confidenceColor(candidate.confidence)} />
              </div>
              <span className="mono tnum">{percentage}%</span>
            </div>
          </>
        )}
      </div>
